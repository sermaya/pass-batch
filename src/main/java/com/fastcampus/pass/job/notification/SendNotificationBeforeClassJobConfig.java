...
public class SendNotificationBeforeClassJobConfig {
    ...
    // notification 데이터 생성
    // notification의 경우 상태값을 update할 필요가 없기 때문에 cursor를 사용할 필요가 없기 때문에
    // paging을 사용한다.
    @Bean
     ...
     * 쿼리당 pageSize 만큼 가져오며 다른 PagingItemReader와 마찬가지로 Thread-safe 합니다.
     * @return
     */
    @Bean
    public JpaPagingItemReader<BookingEntity> addNotificationItemReader() {
        String query = "select b from BooingEntity b join fetch b.userEntity u " +
        ...
        return new JpaPagingItemReaderBuilder<BookingEntity>()
                ...
                .queryString(query)
                .parameterValues(
                        Map.of("status", BookingStatus.READY,
    ...
    public ItemProcessor<BookingEntity, NotificationEntity> addNotificationItemProcessor() {
        // BookingEntity에서 NotificationEntity를 만든다.
        return bookingEntity
                -> NotificationModelMapper.INSTANCE
